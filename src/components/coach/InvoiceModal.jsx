...
export default function InvoiceModal({ coachData, clients = [], onClose, preselectedClient = null }) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label={t("inv.eyebrow")} style={{ position: "fixed", inset: 0, zIndex: 700, background: "rgba(0,0,0,0.7)", WebkitBackdropFilter: "blur(8px)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
