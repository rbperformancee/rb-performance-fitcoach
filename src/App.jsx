  ...
  if (showHome && !isCoach) {
    ...
    return (
      <div style={{minHeight:'100vh',background:'#050505',display:'flex',flexDirection:'column',fontFamily:'-apple-system,Inter,sans-serif',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{display:'flex',justifyContent:'center',paddingBottom:'calc(env(safe-area-inset-bottom, 0px) + 24px)',paddingTop:8}}>
          <nav style={{display:'flex',gap:0,background:'rgba(18,18,18,0.6)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:100,padding:5}}>
            {[
