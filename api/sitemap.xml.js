...
const STATIC_PAGES = [
  ...
  { loc: '/outils/calculateur-tarif-coach-sportif',    changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-paris',                       changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-lyon',                        changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-marseille',                   changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-bordeaux',                    changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-toulouse',                    changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-nice',                        changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-nantes',                      changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-strasbourg',                  changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-lille',                       changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-rennes',                      changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-montpellier',                 changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-grenoble',                    changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-saint-etienne',               changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-reims',                       changefreq: 'monthly', priority: 0.85 },
  { loc: '/coach-sportif-toulon',                      changefreq: 'monthly', priority: 0.85 },
  { loc: '/rb-perform-vs-truecoach',                   changefreq: 'monthly', priority: 0.85 },
  { loc: '/rb-perform-vs-everfit',                     changefreq: 'monthly', priority: 0.85 },
  { loc: '/rb-perform-vs-mycoach',                     changefreq: 'monthly', priority: 0.85 },
  { loc: '/rb-perform-vs-fizzup-pro',                  changefreq: 'monthly', priority: 0.85 },
