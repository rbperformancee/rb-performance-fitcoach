...
export default function AppIcon({ name, size = 20, color = "currentColor", strokeWidth = 1.8, style }) {
  ...
  const map = {
    ...
    keyboard: <svg {...p}><rect x="2" y="6" width="20" height="12" rx="2" /><line x1="6" y1="10" x2="6" y2="10" /><line x1="10" y1="10" x2="10" y2="10" /><line x1="14" y1="10" x2="14" y2="10" /><line x1="18" y1="10" x2="18" y2="10" /><line x1="7" y1="14" x2="17" y2="14" /></svg>,
